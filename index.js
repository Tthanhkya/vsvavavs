...
/*const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! THIS BOT WAS MADE BY ME(S1M4NT0 26X) AND MY BROTHER SIMANTO - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯");
    res.end();
});
...
// THIZ BOT WAS MADE BY ME(S1M4NT0 26X) AND MY BROTHER SIMANTO - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
